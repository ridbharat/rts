const questions = [
     {
        "num": 1,
        "question_en": "What is shortcut open magnifier?",
    ...
    {
        "num": 2,
        "question_en": "Which key opens project menu?",
    ...
    {
        "num": 3,
        "question_en": "What is shortcut ease of access?",
    ...
    {
        "num": 4,
        "question_en": "Which program is voice recorder?",
        "question_hi": "वॉइस रिकॉर्डर कौन सा प्रोग्राम है?",
    ...
    {
        "num": 5,
        "question_en": "What is shortcut system properties?",
    ...
    {
        "num": 6,
        "question_en": "Which key opens Windows help?",
    ...
    {
        "num": 7,
        "question_en": "What is shortcut file properties?",
    ...
    {
        "num": 8,
        "question_en": "Which program is weather?",
        "question_hi": "वेदर कौन सा प्रोग्राम है?",
    ...
    {
        "num": 9,
        "question_en": "What is shortcut rename file?",
        "question_hi": "फाइल रिनेम करने का शॉर्टकट क्या है?",
    ...
    {
        "num": 10,
        "question_en": "Which key refreshes folder?",
    ...
    {
        "num": 11,
        "question_en": "What is shortcut to save file?",
    ...
    },
    {
        ...
        "question_hi": "स्क्रीनशॉट लेने के लिए किस की का उपयोग किया जाता है?",
        "options_en": ["PrtScn", "F12", "Esc", "Tab"],
        "options_hi": ["PrtScn", "F12", "Esc", "Tab"],
        "answer_en": "PrtScn",
        "answer_hi": "PrtScn",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 13,
        "question_en": "What is shortcut to print document?",
    ...
    {
        "num": 14,
        "question_en": "Which program is used to write text?",
        "question_hi": "टेक्स्ट लिखने के लिए किस प्रोग्राम का उपयोग किया जाता है?",
    ...
    {
        "num": 15,
        "question_en": "What is shortcut to open new window?",
        "question_hi": "नई विंडो खोलने का शॉर्टकट क्या है?",
    ...
    {
        "num": 16,
        "question_en": "Which key closes window?",
    ...
    {
        "num": 17,
        "question_en": "What is shortcut to find text?",
    ...
    {
        "num": 19,
        "question_en": "What is shortcut to undo action?",
    ...
    {
        "num": 20,
        "question_en": "Which key switches programs?",
        "question_hi": "प्रोग्राम स्विच करने के लिए किस की का उपयोग किया जाता है?",
    ...
    {
        "num": 21,
        "question_en": "What is shortcut to redo action?",
    ...
    {
        "num": 22,
        "question_en": "Which program is spreadsheet?",
        "question_hi": "स्प्रेडशीट कौन सा प्रोग्राम है?",
    ...
    {
        "num": 23,
        "question_en": "What is shortcut to open file?",
    ...
    {
        "num": 24,
        "question_en": "Which key renames file?",
    ...
    {
        "num": 25,
        "question_en": "What is shortcut to bold text?",
    ...
    {
        "num": 26,
        "question_en": "Which program is presentation?",
        "question_hi": "प्रेजेंटेशन कौन सा प्रोग्राम है?",
    ...
    {
        "num": 27,
        "question_en": "What is shortcut to italic text?",
    ...
    {
        "num": 28,
        "question_en": "Which key deletes permanently?",
        "question_hi": "परमानेंट डिलीट करने के लिए किस की का उपयोग किया जाता है?",
    ...
    {
        "num": 29,
        "question_en": "What is shortcut to underline text?",
    ...
    {
        "num": 30,
        "question_en": "Which program is for email?",
        "question_hi": "ईमेल के लिए कौन सा प्रोग्राम है?",
    ...
    {
        "num": 31,
        "question_en": "What is shortcut to center text?",
        "question_hi": "टेक्स्ट सेंटर करने का शॉर्टकट क्या है?",
    ...
    {
        "num": 32,
        "question_en": "Which key opens context menu?",
        "question_hi": "कॉन्टेक्स्ट मेन्यू खोलने के लिए किस की का उपयोग किया जाता है?",
        "options_en": ["Right-click", "Left-click", "Middle-click", "Double-click"],
        "options_hi": ["राइट-क्लिक", "लेफ्ट-क्लिक", "मिडिल-क्लिक", "डबल-क्लिक"],
        "answer_en": "Right-click",
        "answer_hi": "राइट-क्लिक",
        "attempted": false,
        "selected": ""
    },
    {
        "num": 33,
        "question_en": "What is shortcut to left align?",
        "question_hi": "लेफ्ट अलाइन करने का शॉर्टकट क्या है?",
    ...
    {
        "num": 34,
        "question_en": "Which program for video call?",
        "question_hi": "वीडियो कॉल के लिए कौन सा प्रोग्राम है?",
    ...
    {
        "num": 35,
        "question_en": "What is shortcut to right align?",
        "question_hi": "राइट अलाइन करने का शॉर्टकट क्या है?",
    ...
    {
        "num": 36,
        "question_en": "Which key opens Task Manager?",
    ...
    {
        "num": 37,
        "question_en": "What is shortcut to justify text?",
    ...
    {
        "num": 38,
        "question_en": "Which program for PDF?",
        "question_hi": "PDF के लिए कौन सा प्रोग्राम है?",
    ...
    {
        "num": 39,
        "question_en": "What is shortcut to close tab?",
        "question_hi": "टैब बंद करने का शॉर्टकट क्या है?",
    ...
    {
        "num": 40,
        "question_en": "Which key opens search?",
    ...
    {
        "num": 41,
        "question_en": "What is shortcut for new tab?",
        "question_hi": "नया टैब खोलने का शॉर्टकट क्या है?",
    ...
    {
        "num": 42,
        "question_en": "Which program edits photos?",
        "question_hi": "फोटो एडिट करने के लिए कौन सा प्रोग्राम है?",
    ...
    {
        "num": 43,
        "question_en": "What is shortcut reopen closed tab?",
    ...
    {
        "num": 44,
        "question_en": "Which key locks computer?",
    ...
    {
        "num": 45,
        "question_en": "What is shortcut to address bar?",
    ...
    {
        "num": 46,
        "question_en": "Which program edits videos?",
        "question_hi": "वीडियो एडिट करने के लिए कौन सा प्रोग्राम है?",
    ...
    {
        "num": 47,
        "question_en": "What is shortcut bookmark page?",
    ...
    {
        "num": 48,
        "question_en": "Which key minimizes windows?",
        "question_hi": "विंडोज मिनिमाइज करने के लिए किस की का उपयोग किया जाता है?",
    ...
    {
        "num": 49,
        "question_en": "What is shortcut open bookmarks?",
    ...
    {
        "num": 50,
        "question_en": "Which program for music?",
        "question_hi": "म्यूजिक के लिए कौन सा प्रोग्राम है?",
    ...
    {
        "num": 51,
        "question_en": "What is shortcut to zoom in?",
    ...
    {
        "num": 52,
        "question_en": "Which key shows desktop?",
    ...
    {
        "num": 53,
        "question_en": "What is shortcut to zoom out?",
    ...
    {
        "num": 54,
        "question_en": "Which program for chat?",
        "question_hi": "चैट के लिए कौन सा प्रोग्राम है?",
    ...
    {
        "num": 55,
        "question_en": "What is shortcut reset zoom?",
    ...
    {
        "num": 56,
        "question_en": "Which key opens File Explorer?",
    ...
    {
        "num": 57,
        "question_en": "What is shortcut open history?",
    ...
    {
        "num": 58,
        "question_en": "Which program is antivirus?",
        "question_hi": "एंटीवायरस कौन सा प्रोग्राम है?",
    ...
    {
        "num": 59,
        "question_en": "What is shortcut open downloads?",
    ...
    {
        "num": 60,
        "question_en": "Which key opens Run?",
        "question_hi": "रन खोलने के लिए किस की का उपयोग किया जाता है?",
    ...
    {
        "num": 61,
        "question_en": "What is shortcut open settings?",
        "question_hi": "सेटिंग्स खोलने का शॉर्टकट क्या है?",
    ...
    {
        "num": 62,
        "question_en": "Which program for zip files?",
        "question_hi": "ज़िप फाइलों के लिए कौन सा प्रोग्राम है?",
    ...
    {
        "num": 63,
        "question_en": "What is shortcut open action center?",
        "question_hi": "एक्शन सेंटर खोलने का शॉर्टकट क्या है?",
    ...
    {
        "num": 64,
        "question_en": "Which key opens emoji?",
        "question_hi": "इमोजी खोलने के लिए किस की का उपयोग किया जाता है?",
    ...
    {
        "num": 65,
        "question_en": "What is shortcut task view?",
        "question_hi": "टास्क व्यू खोलने का शॉर्टकट क्या है?",
    ...
    {
        "num": 66,
        "question_en": "Which program is calendar?",
        "question_hi": "कैलेंडर कौन सा प्रोग्राम है?",
    ...
    {
        "num": 67,
        "question_en": "What is shortcut open clipboard?",
        "question_hi": "क्लिपबोर्ड खोलने का शॉर्टकट क्या है?",
    ...
    {
        "num": 68,
        "question_en": "Which key opens game bar?",
    ...
    {
        "num": 69,
        "question_en": "What is shortcut open narrator?",
    ...
    {
        "num": 70,
        "question_en": "Which program is sticky notes?",
        "question_hi": "स्टिकी नोट्स कौन सा प्रोग्राम है?",
    ...
    },
   {
    ...
    {
        "num":72,
        "question_en": "Which program is used to browse internet?",
    ...
    {
        "num": 74,
        "question_en": "Which key is used to refresh webpage?",
    ...
    {
        "num": 75,
        "question_en": "What is shortcut to create new folder?",
    ...
    {
        "num": 76,
        "question_en": "Which bar shows open programs in Windows?",
        "question_hi": "विंडोज में खुले प्रोग्राम कौन सी बार दिखाती है?",
        "options_en": ["Taskbar", "Titlebar", "Menubar", "Toolbar"],
        "options_hi": ["टास्कबार", "टाइटलबार", "मेन्यूबार", "टूलबार"],
        "answer_en": "Taskbar",
        "answer_hi": "टास्कबार",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 77,
        "question_en": "What is file extension for Word document?",
    ...
    },
    {
        ...
        "question_hi": "विंडोज में स्टार्ट मेन्यू कौन सी की खोलती है?",
        "options_en": ["Windows Key", "Ctrl Key", "Alt Key", "Shift Key"],
        "options_hi": ["विंडोज की", "कंट्रोल की", "आल्ट की", "शिफ्ट की"],
    ...
    {
        "num": 79,
        "question_en": "What is shortcut to select all text?",
    ...
    {
        "num": 81,
        "question_en": "What is shortcut search in folder?",
    ...
    {
        "num": 82,
        "question_en": "Which program is news?",
        "question_hi": "न्यूज़ कौन सा प्रोग्राम है?",
    ...
    {
        "num": 83,
        "question_en": "What is shortcut open address bar?",
        "question_hi": "एड्रेस बार खोलने का शॉर्टकट क्या है?",
    ...
    {
        "num": 84,
        "question_en": "Which key spell check?",
    ...
    {
        "num": 85,
        "question_en": "What is shortcut safe mode?",
        "question_hi": "सेफ मोड का शॉर्टकट क्या है?",
    ...
    {
        "num": 86,
        "question_en": "Which program is maps?",
        "question_hi": "मैप्स कौन सा प्रोग्राम है?",
        "options_en": ["Maps", "Weather", "News", "Sports"],
        "options_hi": ["मैप्स", "वेदर", "न्यूज़", "स्पोर्ट्स"],
        "answer_en": "Maps",
        "answer_hi": "मैप्स",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 87,
        "question_en": "What is shortcut boot menu?",
        "question_hi": "बूट मेन्यू का शॉर्टकट क्या है?",
    ...
    {
        "num": 88,
        "question_en": "Which key opens BIOS?",
    ...
    {
        "num": 89,
        "question_en": "What is shortcut developer tools?",
        "question_hi": "डेवलपर टूल्स का शॉर्टकट क्या है?",
    ...
    {
        "num": 90,
        "question_en": "Which program is alarms?",
        "question_hi": "अलार्म कौन सा प्रोग्राम है?",
        "options_en": ["Alarms & Clock", "Calculator", "Calendar", "Weather"],
        "options_hi": ["अलार्म्स एंड क्लॉक", "कैलकुलेटर", "कैलेंडर", "वेदर"],
        "answer_en": "Alarms & Clock",
        "answer_hi": "अलार्म्स एंड क्लॉक",
        "attempted": false,
        "selected": ""
    },
    {
        "num": 91,
        "question_en": "What is shortcut full screen?",
    ...
    {
        "num": 92,
        "question_en": "Which key opens menu bar?",
    ...
    {
        "num": 93,
        "question_en": "What is shortcut inspect element?",
        "question_hi": "इन्स्पेक्ट एलिमेंट का शॉर्टकट क्या है?",
    ...
    {
        "num": 94,
        "question_en": "Which program is camera?",
        "question_hi": "कैमरा कौन सा प्रोग्राम है?",
        "options_en": ["Camera", "Photos", "Paint", "Movie Maker"],
        "options_hi": ["कैमरा", "फोटोज़", "पेंट", "मूवी मेकर"],
        "answer_en": "Camera",
        "answer_hi": "कैमरा",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 95,
        "question_en": "What is shortcut console?",
        "question_hi": "कंसोल का शॉर्टकट क्या है?",
    ...
    {
        "num": 96,
        "question_en": "Which key find replace?",
        "question_hi": "फाइंड रिप्लेस के लिए किस की का उपयोग किया जाता है?",
    ...
    {
        "num": 97,
        "question_en": "What is shortcut go to line?",
        "question_hi": "गो टू लाइन का शॉर्टकट क्या है?",
    ...
    {
        "num": 98,
        "question_en": "Which program is photos?",
        "question_hi": "फोटोज़ कौन सा प्रोग्राम है?",
        "options_en": ["Photos", "Camera", "Paint", "Movie Maker"],
        "options_hi": ["फोटोज़", "कैमरा", "पेंट", "मूवी मेकर"],
        "answer_en": "Photos",
        "answer_hi": "फोटोज़",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 99,
        "question_en": "What is shortcut page setup?",
        "question_hi": "पेज सेटअप का शॉर्टकट क्या है?",
    ...
    {
        "num": 100,
        "question_en": "Which key print preview?",
        "question_hi": "प्रिंट प्रिव्यू के लिए किस की का उपयोग किया जाता है?",
