const questions=[
    {
        "num": 1,
        "question_en": "The process of converting sugar into alcohol by yeast is called:",
        "question_hi": "यीस्ट द्वारा चीनी को अल्कोहल में बदलने की प्रक्रिया को कहते हैं:",
    ...
    },
    {
        ...
        "options_en": ["Sepal", "Petal", "Ovary", "Stamen"],
        "options_hi": ["बाह्यदल", "पंखुड़ी", "अंडाशय", "पुंकेसर"],
        "answer_en": "Ovary",
        "answer_hi": "अंडाशय",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 3,
        "question_en": "The instrument used to measure blood pressure is:",
        "question_hi": "रक्तचाप मापने के लिए उपयोग किया जाने वाला उपकरण है:",
        "options_en": ["Thermometer", "Sphygmomanometer", "Stethoscope", "Barometer"],
        "options_hi": ["थर्मामीटर", "स्फिग्मोमैनोमीटर", "स्टेथोस्कोप", "बैरोमीटर"],
    ...
    {
        "num": 5,
        "question_en": "The hardest substance in human body is:",
        "question_hi": "मानव शरीर में सबसे कठोर पदार्थ है:",
        "options_en": ["Bone", "Tooth enamel", "Nail", "Cartilage"],
        "options_hi": ["हड्डी", "दाँत का इनेमल", "नाखून", "उपास्थि"],
        "answer_en": "Tooth enamel",
        "answer_hi": "दाँत का इनेमल",
        "attempted": false,
        "selected": ""
    },
    {
    ...
    {
        "num": 8,
        "question_en": "The process of making food by plants using sunlight is:",
        "question_hi": "सूर्य के प्रकाश का उपयोग करके पौधों द्वारा भोजन बनाने की प्रक्रिया है:",
    ...
    {
        "num": 9,
        "question_en": "Which mirror is used by dentists?",
        "question_hi": "दंत चिकित्सक किस दर्पण का उपयोग करते हैं?",
    ...
    },
    {
        ...
        "question_hi": "विज्ञापन संकेतों में किस गैस का उपयोग किया जाता है?",
    ...
    },
    {
        ...
        "question_hi": "पौधे का कौन सा भाग भोजन संवहन करता है?",
    ...
    {
        "num": 16,
        "question_en": "The process of separating cream from milk is called:",
        "question_hi": "दूध से क्रीम अलग करने की प्रक्रिया को कहते हैं:",
        "options_en": ["Filtration", "Centrifugation", "Evaporation", "Distillation"],
        "options_hi": ["छानना", "अपकेंद्रण", "वाष्पीकरण", "आसवन"],
        "answer_en": "Centrifugation",
        "answer_hi": "अपकेंद्रण",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["Copper", "Chromium", "Zinc", "Lead"],
        "options_hi": ["ताँबा", "क्रोमियम", "जस्ता", "सीसा"],
        "answer_en": "Chromium",
        "answer_hi": "क्रोमियम",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 18,
        "question_en": "Which gland is located in the neck?",
        "question_hi": "कौन सी ग्रंथि गर्दन में स्थित होती है?",
    ...
    },
    {
        ...
        "question_hi": "साधारण फिटकरी का रासायनिक सूत्र क्या है?",
        "options_en": ["K₂SO₄·Al₂(SO₄)₃·24H₂O", "Na₂CO₃", "CaSO₄", "MgSO₄"],
        "options_hi": ["K₂SO₄·Al₂(SO₄)₃·24H₂O", "Na₂CO₃", "CaSO₄", "MgSO₄"],
    ...
    {
        "num": 21,
        "question_en": "The process of digestion starts with which enzyme?",
        "question_hi": "पाचन की प्रक्रिया किस एंजाइम से शुरू होती है?",
