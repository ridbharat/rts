const questions=[
    ...
    {
        "num": 2,
        "question_en": "The process of converting milk into curd is called:",
        "question_hi": "दूध को दही में बदलने की प्रक्रिया को कहते हैं:",
        "options_en": ["Pasteurization", "Fermentation", "Distillation", "Evaporation"],
        "options_hi": ["पाश्चुरीकरण", "किण्वन", "आसवन", "वाष्पीकरण"],
    ...
    {
        "num": 5,
        "question_en": "The structural and functional unit of kidney is:",
        "question_hi": "गुर्दे की संरचनात्मक और कार्यात्मक इकाई है:",
        "options_en": ["Neuron", "Nephron", "Alveoli", "Villus"],
        "options_hi": ["न्यूरॉन", "नेफ्रॉन", "एल्वियोली", "विलस"],
        "answer_en": "Nephron",
        "answer_hi": "नेफ्रॉन",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["Iron", "Copper", "Gold", "All of these"],
        "options_hi": ["लोहा", "ताँबा", "सोना", "ये सभी"],
    ...
    {
        "num": 8,
        "question_en": "The process of conversion of water into water vapor is called:",
        "question_hi": "पानी को जलवाष्प में बदलने की प्रक्रिया को कहते हैं:",
    ...
    {
        "num": 9,
        "question_en": "Which mirror is used as a shaving mirror?",
        "question_hi": "शेविंग मिरर के रूप में किस दर्पण का उपयोग किया जाता है?",
    ...
    },
    {
        ...
        "question_hi": "फूल का कौन सा भाग परागकण उत्पन्न करता है?",
        "options_en": ["Sepal", "Petal", "Anther", "Stigma"],
        "options_hi": ["बाह्यदल", "पंखुड़ी", "परागकोष", "वर्तिकाग्र"],
        "answer_en": "Anther",
        "answer_hi": "परागकोष",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["Pt", "Pl", "Pm", "Pa"],
        "options_hi": ["Pt", "Pl", "Pm", "Pa"],
        "answer_en": "Pt",
        "answer_hi": "Pt",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 16,
        "question_en": "The process of converting iron into steel is called:",
        "question_hi": "लोहे को स्टील में बदलने की प्रक्रिया को कहते हैं:",
        "options_en": ["Galvanization", "Alloying", "Smelting", "Refining"],
        "options_hi": ["जस्तीकरण", "मिश्रधातु बनाना", "गलाना", "शुद्धिकरण"],
        "answer_en": "Alloying",
        "answer_hi": "मिश्रधातु बनाना",
        "attempted": false,
        "selected": ""
    },
    {
        "num": 17,
        "question_en": "Which metal is used in making dental fillings?",
        "question_hi": "दंत भराव बनाने में किस धातु का उपयोग किया जाता है?",
        "options_en": ["Iron", "Copper", "Mercury", "Silver amalgam"],
        "options_hi": ["लोहा", "ताँबा", "पारा", "चाँदी अमलगम"],
        "answer_en": "Silver amalgam",
        "answer_hi": "चाँदी अमलगम",
        "attempted": false,
        "selected": ""
    },
    {
    ...
    },
    {
        ...
        "question_hi": "लाइट बल्बों में किस गैस का उपयोग किया जाता है?",
    ...
    {
        "num": 21,
        "question_en": "The process of digestion completes in which organ?",
        "question_hi": "पाचन की प्रक्रिया किस अंग में पूरी होती है?",
    ...
    },
    {
        ...
        "options_en": ["MgSO₄·7H₂O", "Na₂SO₄·10H₂O", "CaSO₄·2H₂O", "CuSO₄·5H₂O"],
        "options_hi": ["MgSO₄·7H₂O", "Na₂SO₄·10H₂O", "CaSO₄·2H₂O", "CuSO₄·5H₂O"],
        "answer_en": "MgSO₄·7H₂O",
        "answer_hi": "MgSO₄·7H₂O",
        "attempted": false,
        "selected": ""
