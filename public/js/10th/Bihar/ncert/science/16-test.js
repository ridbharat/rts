const questions=[
    {
        ...
        "question_hi": "निम्नलिखित में से कौन सा जैव निम्नीकरणीय अपशिष्ट है?",
        "options_en": ["Plastic", "Glass", "Paper", "Metal"],
        "options_hi": ["प्लास्टिक", "काँच", "कागज", "धातु"],
        "answer_en": "Paper",
        "answer_hi": "कागज",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 2,
        "question_en": "The process of converting atmospheric nitrogen into usable form is called:",
        "question_hi": "वायुमंडलीय नाइट्रोजन को उपयोगी रूप में बदलने की प्रक्रिया को कहते हैं:",
    ...
    {
        "num": 5,
        "question_en": "The tissue that connects bone to bone is called:",
        "question_hi": "वह ऊतक जो हड्डी को हड्डी से जोड़ता है, कहलाता है:",
        "options_en": ["Tendon", "Ligament", "Cartilage", "Muscle"],
        "options_hi": ["टेंडन", "लिगामेंट", "कार्टिलेज", "मांसपेशी"],
        "answer_en": "Ligament",
        "answer_hi": "लिगामेंट",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 6,
        "question_en": "Which metal is used in making galvanized iron?",
        "question_hi": "गैल्वनाइज्ड आयरन बनाने में किस धातु का उपयोग किया जाता है?",
        "options_en": ["Copper", "Zinc", "Tin", "Lead"],
        "options_hi": ["ताँबा", "जस्ता", "टिन", "सीसा"],
        "answer_en": "Zinc",
        "answer_hi": "जस्ता",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 8,
        "question_en": "The process of seed germination requires:",
        "question_hi": "बीज के अंकुरण की प्रक्रिया के लिए आवश्यक है:",
        "options_en": ["Water, air, and sunlight", "Water, air, and suitable temperature", "Only water", "Only air"],
        "options_hi": ["पानी, वायु और सूर्य प्रकाश", "पानी, वायु और उपयुक्त तापमान", "केवल पानी", "केवल वायु"],
        "answer_en": "Water, air, and suitable temperature",
        "answer_hi": "पानी, वायु और उपयुक्त तापमान",
        "attempted": false,
        "selected": ""
    },
    {
    ...
    },
    {
        ...
        "question_hi": "प्रकाश तीव्रता की SI इकाई है:",
    ...
    {
        "num": 12,
        "question_en": "Which gas is used in making vegetable ghee?",
    ...
    {
        "num": 13,
        "question_en": "Which part of the plant contains chlorophyll?",
        "question_hi": "पौधे का कौन सा भाग क्लोरोफिल रखता है?",
    ...
    {
        "num": 16,
        "question_en": "The process of converting milk into paneer is called:",
        "question_hi": "दूध को पनीर में बदलने की प्रक्रिया को कहते हैं:",
        "options_en": ["Pasteurization", "Coagulation", "Fermentation", "Distillation"],
        "options_hi": ["पाश्चुरीकरण", "जमाव", "किण्वन", "आसवन"],
    ...
    },
    {
        ...
        "options_en": ["Iron", "Copper", "Bronze", "Both B and C"],
        "options_hi": ["लोहा", "ताँबा", "कांस्य", "B और C दोनों"],
    ...
    {
        "num": 18,
        "question_en": "Which gland regulates metabolism in the body?",
        "question_hi": "शरीर में चयापचय को कौन सी ग्रंथि नियंत्रित करती है?",
    ...
    },
    {
        ...
        "options_en": ["NaOH", "NaHCO₃", "Na₂CO₃", "NaCl"],
        "options_hi": ["NaOH", "NaHCO₃", "Na₂CO₃", "NaCl"],
        "answer_en": "NaOH",
        "answer_hi": "NaOH",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "question_hi": "शरीर में भोजन को तोड़ने की प्रक्रिया को कहते हैं:",
    ...
    },
    {
        ...
        "options_hi": ["लोहा", "पारा", "ताँबा", "एल्यूमीनियम"],
        "answer_en": "Mercury",
        "answer_hi": "पारा",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "question_hi": "विज्ञापन साइनों (नियोन लाइट्स) में किस गैस का उपयोग किया जाता है?",
        "options_en": ["Helium", "Neon", "Argon", "Krypton"],
        "options_hi": ["हीलियम", "नियॉन", "आर्गन", "क्रिप्टन"],
        "answer_en": "Neon",
        "answer_hi": "नियॉन",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "options_en": ["O₂", "O₃", "O₄", "H₂O"],
        "options_hi": ["O₂", "O₃", "O₄", "H₂O"],
        "answer_en": "O₃",
        "answer_hi": "O₃",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "question_hi": "हमारे सौर मंडल में सबसे ठंडा ग्रह कौन सा है?",
    ...
    },
    {
        ...
        "question_hi": "मानव शरीर सूर्य के प्रकाश के संपर्क में आने पर किस विटामिन का उत्पादन करता है?",
        "options_en": ["Vitamin A", "Vitamin B", "Vitamin C", "Vitamin D"],
        "options_hi": ["विटामिन ए", "विटामिन बी", "विटामिन सी", "विटामिन डी"],
        "answer_en": "Vitamin D",
        "answer_hi": "विटामिन डी",
    ...
    },
    {
        ...
        "options_en": ["Acetic acid", "Citric acid", "Oxalic acid", "Malic acid"],
        "options_hi": ["एसिटिक अम्ल", "साइट्रिक अम्ल", "ऑक्सालिक अम्ल", "मैलिक अम्ल"],
    ...
    },
    {
        ...
        "question_hi": "कौन सा विटामिन रक्त के थक्के बनाने में मदद करता है?",
    ...
    },
    {
        ...
        "options_en": ["Citric acid", "Ascorbic acid", "Malic acid", "Both A and B"],
        "options_hi": ["साइट्रिक अम्ल", "एस्कॉर्बिक अम्ल", "मैलिक अम्ल", "A और B दोनों"],
    ...
    },
    {
        ...
        "options_en": ["Citric acid", "Tartaric acid", "Malic acid", "Oxalic acid"],
        "options_hi": ["साइट्रिक अम्ल", "टार्टरिक अम्ल", "मैलिक अम्ल", "ऑक्सालिक अम्ल"],
        "answer_en": "Tartaric acid",
        "answer_hi": "टार्टरिक अम्ल",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "question_hi": "हमारे सौर मंडल में सबसे गर्म ग्रह कौन सा है?",
        "options_en": ["Mercury", "Venus", "Mars", "Jupiter"],
        "options_hi": ["बुध", "शुक्र", "मंगल", "बृहस्पति"],
        "answer_en": "Venus",
        "answer_hi": "शुक्र",
    ...
    },
    {
        ...
        "options_en": ["Ld", "Pb", "Pd", "Pt"],
        "options_hi": ["Ld", "Pb", "Pd", "Pt"],
        "answer_en": "Pb",
        "answer_hi": "Pb",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "question_hi": "किस विटामिन की कमी से घातक रक्ताल्पता (पर्निशियस एनीमिया) होता है?",
        "options_en": ["Vitamin B9", "Vitamin B12", "Vitamin C", "Vitamin D"],
        "options_hi": ["विटामिन B9", "विटामिन B12", "विटामिन सी", "विटामिन डी"],
    ...
    },
    {
        ...
        "options_en": ["Hydrochloric acid", "Nitric acid", "Sulfuric acid", "Phosphoric acid"],
        "options_hi": ["हाइड्रोक्लोरिक अम्ल", "नाइट्रिक अम्ल", "सल्फ्यूरिक अम्ल", "फॉस्फोरिक अम्ल"],
        "answer_en": "Sulfuric acid",
        "answer_hi": "सल्फ्यूरिक अम्ल",
        "attempted": false,
        "selected": ""
