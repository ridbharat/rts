[
    {
        ...
        "options_hi": ["नाइट्रोजन", "ऑक्सीजन", "ऑर्गन", "कार्बन डाइऑक्साइड"],
        "answer_en": "Nitrogen",
        "answer_hi": "नाइट्रोजन",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "question_hi": "किस ग्रह की वलय प्रणाली सबसे व्यापक है?",
    ...
    },
    {
        ...
        "options_en": ["Vitamin C", "Vitamin B1", "Vitamin B6", "Vitamin D"],
        "options_hi": ["विटामिन सी", "विटामिन बी1", "विटामिन बी6", "विटामिन डी"],
        "answer_en": "Vitamin C",
    ...
    {
        "num": 17,
        "question_en": "Which acid is present in citrus fruits?",
        "question_hi": "खट्टे फलों में कौन सा अम्ल मौजूद होता है?",
        "options_en": ["Citric acid", "Malic acid", "Tartaric acid", "Oxalic acid"],
        "options_hi": ["साइट्रिक अम्ल", "मैलिक अम्ल", "टार्टरिक अम्ल", "ऑक्सालिक अम्ल"],
    ...
    {
        "num": 25,
        "question_en": "Which planet is known for its prominent blue color due to methane?",
        "question_hi": "कौन सा ग्रह मीथेन के कारण अपने विशिष्ट नीले रंग के लिए जाना जाता है?",
    ...
    },
    {
        ...
        "options_en": ["Vitamin K", "Vitamin E", "Vitamin B6", "Vitamin C"],
        "options_hi": ["विटामिन K", "विटामिन ई", "विटामिन बी6", "विटामिन सी"],
        "answer_en": "Vitamin K",
        "answer_hi": "विटामिन K",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["Joule", "Watt", "Volt", "Ohm"],
        "options_hi": ["जूल", "वाट", "वोल्ट", "ओम"],
        "answer_en": "Joule",
        "answer_hi": "जूल",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 31,
        "question_en": "Which moon is known to have subsurface oceans?",
        "question_hi": "किस चंद्रमा के भूमिगत समुद्र होने के बारे में जाना जाता है?",
        "options_en": ["Europa", "Moon", "Titan", "Phobos"],
        "options_hi": ["यूरोपा", "चंद्रमा", "टाइटन", "फोबोस"],
        "answer_en": "Europa",
        "answer_hi": "यूरोपा",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "question_hi": "ताँबे का रासायनिक प्रतीक क्या है?",
        "options_en": ["Cu", "Co", "Cr", "Cp"],
        "options_hi": ["Cu", "Co", "Cr", "Cp"],
        "answer_en": "Cu",
        "answer_hi": "Cu",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["Vitamin K", "Vitamin D", "Vitamin B12", "Vitamin C"],
        "options_hi": ["विटामिन K", "विटामिन डी", "विटामिन बी12", "विटामिन सी"],
        "answer_en": "Vitamin K",
        "answer_hi": "विटामिन K",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "question_hi": "खाद्य परिरक्षण में किस अम्ल का उपयोग किया जाता है?",
    ...
    },
    {
        ...
        "question_hi": "हमारे सौरमंडल का सबसे गर्म ग्रह कौन सा है?",
    ...
    {
        "num": 39,
        "question_en": "Which vitamin deficiency causes osteomalacia in adults?",
        "question_hi": "किस विटामिन की कमी से वयस्कों में ऑस्टियोमलेशिया होता है?",
    ...
    },
    {
        ...
        "options_en": ["Acrylic acid", "Sulfuric acid", "Nitric acid", "Hydrochloric acid"],
        "options_hi": ["एक्रिलिक अम्ल", "सल्फ्यूरिक अम्ल", "नाइट्रिक अम्ल", "हाइड्रोक्लोरिक अम्ल"],
    ...
    },
    {
        ...
        "options_en": ["H₂SO₄", "H₂SO₃", "HSO₄", "SO₃"],
        "options_hi": ["H₂SO₄", "H₂SO₃", "HSO₄", "SO₃"],
        "answer_en": "H₂SO₄",
        "answer_hi": "H₂SO₄",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 45,
        "question_en": "Which vitamin is an antioxidant?",
        "question_hi": "कौन सा विटामिन एक एंटीऑक्सीडेंट है?",
        "options_en": ["Vitamin E", "Vitamin K", "Vitamin B1", "Vitamin D"],
        "options_hi": ["विटामिन ई", "विटामिन K", "विटामिन बी1", "विटामिन डी"],
        "answer_en": "Vitamin E",
        "answer_hi": "विटामिन ई",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "question_hi": "रंजकों के उत्पादन में किस अम्ल का उपयोग किया जाता है?",
        "options_en": ["Sulfuric acid", "Nitric acid", "Both", "Acetic acid"],
        "options_hi": ["सल्फ्यूरिक अम्ल", "नाइट्रिक अम्ल", "दोनों", "एसिटिक अम्ल"],
        "answer_en": "Both",
        "answer_hi": "दोनों",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["HNO₃", "HNO₂", "NO₂", "N₂O₅"],
        "options_hi": ["HNO₃", "HNO₂", "NO₂", "N₂O₅"],
        "answer_en": "HNO₃",
        "answer_hi": "HNO₃",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "question_hi": "किस ग्रह की कक्षा सबसे अधिक उत्केंद्रित है?",
    ...
    },
    {
        ...
        "question_hi": "SI में तापमान की इकाई क्या है?",
    ...
    {
        "num": 53,
        "question_en": "Which enzyme is responsible for converting starch into maltose?",
        "question_hi": "स्टार्च को माल्टोज़ में बदलने के लिए कौन सा एंजाइम जिम्मेदार है?",
    ...
    },
    {
        ...
        "question_en": "What is the chemical formula of Methane?",
        "question_hi": "मीथेन का रासायनिक सूत्र क्या है?",
        "options_en": ["CH₄", "C₂H₆", "CO₂", "H₂O"],
        "options_hi": ["CH₄", "C₂H₆", "CO₂", "H₂O"],
        "answer_en": "CH₄",
        "answer_hi": "CH₄",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "question_hi": "किस विटामिन को एस्कॉर्बिक एसिड के नाम से जाना जाता है?",
    ...
    },
    {
        ...
        "question_en": "What is the unit of frequency?",
        "question_hi": "आवृत्ति की इकाई क्या है?",
        "options_en": ["Hertz", "Decibel", "Ohm", "Volt"],
        "options_hi": ["हर्ट्ज़", "डेसिबल", "ओम", "वोल्ट"],
        "answer_en": "Hertz",
        "answer_hi": "हर्ट्ज़",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "options_en": ["Ganymede", "Titan", "Moon", "Europa"],
        "options_hi": ["गेनीमेड", "टाइटन", "चंद्रमा", "यूरोपा"],
        "answer_en": "Ganymede",
        "answer_hi": "गेनीमेड",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "question_en": "What is the chemical symbol for Gold?",
        "question_hi": "सोने का रासायनिक प्रतीक क्या है?",
        "options_en": ["Au", "Ag", "Pb", "Cu"],
        "options_hi": ["Au", "Ag", "Pb", "Cu"],
        "answer_en": "Au",
        "answer_hi": "Au",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 65,
        "question_en": "Which vitamin is produced by our skin when exposed to sunlight?",
        "question_hi": "सूरज की रोशनी के संपर्क में आने पर हमारी त्वचा कौन सा विटामिन उत्पन्न करती है?",
        "options_en": ["Vitamin D", "Vitamin A", "Vitamin E", "Vitamin K"],
        "options_hi": ["विटामिन डी", "विटामिन ए", "विटामिन ई", "विटामिन K"],
        "answer_en": "Vitamin D",
        "answer_hi": "विटामिन डी",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "options_en": ["Citric Acid", "Acetic Acid", "Oxalic Acid", "Tartaric Acid"],
        "options_hi": ["साइट्रिक अम्ल", "एसिटिक अम्ल", "ऑक्सैलिक अम्ल", "टार्टरिक अम्ल"],
        "answer_en": "Citric Acid",
        "answer_hi": "साइट्रिक अम्ल",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "options_en": ["Ag", "Au", "Al", "Si"],
        "options_hi": ["Ag", "Au", "Al", "Si"],
        "answer_en": "Ag",
        "answer_hi": "Ag",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "question_hi": "कौन सा विटामिन रक्त के थक्के बनने में मदद करता है?",
        "options_en": ["Vitamin K", "Vitamin C", "Vitamin B12", "Vitamin E"],
        "options_hi": ["विटामिन K", "विटामिन सी", "विटामिन बी12", "विटामिन ई"],
        "answer_en": "Vitamin K",
        "answer_hi": "विटामिन K",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "options_hi": ["फॉर्मिक अम्ल", "एसिटिक अम्ल", "लैक्टिक अम्ल", "साइट्रिक अम्ल"],
    ...
    {
        "num": 75,
        "question_en": "Which moon orbits Mars?",
        "question_hi": "कौन सा चंद्रमा मंगल की परिक्रमा करता है?",
        "options_en": ["Phobos and Deimos", "Titan", "Ganymede", "Europa"],
        "options_hi": ["फोबोस और डीमोस", "टाइटन", "गेनीमेड", "यूरोपा"],
        "answer_en": "Phobos and Deimos",
        "answer_hi": "फोबोस और डीमोस",
        "attempted": false,
        "selected": ""
    },
    {
    ...
    },
    {
        ...
        "options_en": ["Vitamin E", "Vitamin K", "Vitamin B1", "Vitamin A"],
        "options_hi": ["विटामिन ई", "विटामिन K", "विटामिन बी1", "विटामिन ए"],
        "answer_en": "Vitamin E",
        "answer_hi": "विटामिन ई",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 83,
        "question_en": "Which vitamin helps in maintaining good vision?",
        "question_hi": "कौन सा विटामिन अच्छी दृष्टि बनाए रखने में मदद करता है?",
    ...
    {
        "num": 84,
        "question_en": "What is the unit of work or energy?",
        "question_hi": "कार्य या ऊर्जा की इकाई क्या है?",
    ...
    },
    {
        ...
        "question_en": "What is the chemical formula of Nitric Acid?",
        "question_hi": "नाइट्रिक अम्ल का रासायनिक सूत्र क्या है?",
        "options_en": ["HNO₃", "HCl", "H₂SO₄", "H₃PO₄"],
        "options_hi": ["HNO₃", "HCl", "H₂SO₄", "H₃PO₄"],
        "answer_en": "HNO₃",
        "answer_hi": "HNO₃",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 87,
        "question_en": "Which moon has active volcanoes?",
        "question_hi": "किस चंद्रमा पर सक्रिय ज्वालामुखी हैं?",
        "options_en": ["Io", "Moon", "Titan", "Europa"],
        "options_hi": ["आईओ", "चंद्रमा", "टाइटन", "यूरोपा"],
        "answer_en": "Io",
        "answer_hi": "आईओ",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "question_en": "What is the chemical symbol for Mercury?",
        "question_hi": "पारे का रासायनिक प्रतीक क्या है?",
        "options_en": ["Hg", "Mg", "Ag", "Au"],
        "options_hi": ["Hg", "Mg", "Ag", "Au"],
        "answer_en": "Hg",
        "answer_hi": "Hg",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 90,
        "question_en": "What is the unit of temperature in SI system?",
        "question_hi": "SI प्रणाली में तापमान की इकाई क्या है?",
        "options_en": ["Kelvin", "Celsius", "Fahrenheit", "Rankine"],
        "options_hi": ["केल्विन", "सेल्सियस", "फारेनहाइट", "रैंकिन"],
        "answer_en": "Kelvin",
        "answer_hi": "केल्विन",
    ...
    },
    {
        ...
        "question_hi": "किस ग्रह के सबसे प्रमुख छल्ले हैं?",
        "options_en": ["Saturn", "Jupiter", "Uranus", "Neptune"],
        "options_hi": ["शनि", "बृहस्पति", "युरेनस", "नेपच्यून"],
        "answer_en": "Saturn",
        "answer_hi": "शनि",
    ...
    },
    {
        ...
        "options_hi": ["विटामिन डी", "विटामिन ए", "विटामिन सी", "विटामिन K"],
        "answer_en": "Vitamin D",
        "answer_hi": "विटामिन डी",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "options_en": ["Tartaric Acid", "Citric Acid", "Acetic Acid", "Oxalic Acid"],
        "options_hi": ["टार्टरिक अम्ल", "साइट्रिक अम्ल", "एसिटिक अम्ल", "ऑक्सैलिक अम्ल"],
        "answer_en": "Tartaric Acid",
        "answer_hi": "टार्टरिक अम्ल",
        "attempted": false,
        "selected": ""
    ...
    },
    {
        ...
        "question_hi": "किस ग्रह को इसके 'ग्रेट डार्क स्पॉट' के लिए जाना जाता है?",
