...
},
{
  ...
  question_hi: "पेनिसिलिन किसने खोजा?",
...
},
{
  ...
  question_hi: "कौन सा तत्व 'O' रासायनिक चिन्ह वाला है?",
  options_en: ["Oxygen", "Gold", "Silver", "Hydrogen"],
  options_hi: ["ऑक्सीजन", "सोना", "चाँदी", "हाइड्रोजन"],
  answer_en: "Oxygen",
  answer_hi: "ऑक्सीजन",
  attempted: false,
  selected: ""
...
},
{
  ...
  options_en: ["B.R. Ambedkar", "Mahatma Gandhi", "Jawaharlal Nehru", "Sardar Patel"],
  options_hi: ["भीमराव अंबेडकर", "महात्मा गांधी", "जवाहरलाल नेहरू", "सर्दार पटेल"],
...
},
{
  ...
  options_hi: ["अलेक्जेंडर ग्राहम बेल", "थॉमस एडिसन", "निकोला टेस्ला", "गुलेल्मो मार्कोनी"],
...
},
{
  ...
  question_hi: "पृथ्वी की परिक्रमा करने वाला पहला भारतीय उपग्रह कौन सा था?",
...
},
{
  ...
  question_hi: "'पाँच नदियों की भूमि' के नाम से कौन सा राज्य जाना जाता है?",
...
},
{
  ...
  options_en: ["Dr. A.P.J. Abdul Kalam", "Vikram Sarabhai", "Homi Bhabha", "C.V. Raman"],
  options_hi: ["डॉ. ए.पी.जे. अब्दुल कलाम", "विक्रम साराभाई", "होमी भाभा", "सी.वी. रमन"],
